...
void Machine::runAll(Memory& mem, Register& reg, Instructions& inst) {
    runInstruction(mem, reg,inst);
    cout << "\nFinal Register :\n";
    getRegister();
    cout << "Final Memory :\n";
    getMemory();
...
void Machine::runInstruction(Memory& mem, Register& reg, Instructions& inst) {
    int i = 0;
    vector<string> instructions = inst.getInstructions();
    mem.programCounterIncrement(instructions);
    int programCounter = mem.getProgramCounter();
